...
function mostrarusuario(qstr)
{
    ...
    xhttp.open("GET", "../funciones_php/Consulta_usuario.php?q="+ encodeURIComponent(qstr), true);
     xhttp.send();
}


function actualizarusuario(qstr)
{
    var xhttp;
    if (qstr == "") {
        document.getElementById("tabladatos").innerHTML = "";
    ...
    xhttp.open("GET", "../funciones_php/actualizar_usuario.php?q="+ encodeURIComponent(qstr), true);
     xhttp.send();
}
