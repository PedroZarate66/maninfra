...
<?php
    ...
    $obj_consul_inf_ind = new Consulta_Infraestructura_Ind;
...
<div class="container-fluid text-center">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['reg_eliminar']))
    {
        ...
        $codigoCreado = $_GET["codigoCreado"];
        $codigoV      = $_GET["codigo"];
        ...
        if($codigoCreado == $codigoV){
                ...
                //SE INVOCA EL METODO DE ELIMINACION
            ...
            echo "<script>
                    ...
                    window.location= '../Historial_infraestructura/'
            </script>";
        }
    }
    if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['origen']))
    {
        ...
        if($codigoCreado == $codigoV){
                //CODIGO DONDE SE INVOCA AL METODO PARA ENVIAR EL MENSAJE DE ELMINACION
                $registro = $obj_consul_inf_ind->consulta_infraestructura_individual($infraestructuraEliminar);
                //SE OBTIENE EL NOMBRE DE USUARIO
                $usuario = $_SESSION['usuario'];
                //SE CREA EL MENSAJE Y DESPUES SE ENVIA
    ...
    <div class="modal-dialog modal-dialog-centered modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid text-center">
                    <input class='form-control' id='codigo' name='codigo' aria-describedby='codigo verificacion' required>
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cerrar</button>
