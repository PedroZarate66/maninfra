...
<html lang="es">
    ...
    <?php
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            echo "<div class='container-fluid'><h5 class='text-center'>Registro de calendario actualizado con exito</h5>";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['reg_eliminar']))
            {
                ...
                if($codigoCreado == $codigoV){
                        ...
                        header('Location: ../Editar_registro/');
                }else{
                    echo "<script>
                            alert('codigo invalido');
                            window.location= '../Editar_registro'
                    </script>";
                }
