...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="../../inspecciones/Verificacion_sistemas/estilos.css">
    ...
    <?php require 'Configuracion_sesion.php'; ?>
    <body>
        
        <nav class="banner2">
            <div class="nav navbar-nav">
                <a class="nav-item nav-link active" href="../inspecciones/Historial_Inspecciones/" aria-current="page"
                    >Regresar</a>
            </div>
        </nav>
        <main class="content">
        <?php
            ...
            $consulta = $ayudante->manejador->consulta_registro_individual($idconsulta);
            }
