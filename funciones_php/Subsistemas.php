...
class adminMariaDB extends Admin_sql{
    ...
    public function tratamiento_registro()
    {
        ...
        $registroentrada[55] = $_POST["electrogeno_fugagenerador_c"];
        $registroentrada[56] = $_POST["electrogeno_fugagenerador_d"];
        $registroentrada[51] = $_POST["electrogeno_ruidogenerador_a"];
        $registroentrada[52] = $_POST["electrogeno_ruidogenerador_b"];
        $registroentrada[57] = $_POST["electrogeno_ruidogenerador_c"];
        $registroentrada[58] = $_POST["electrogeno_ruidogenerador_d"];
        ...
        //$registroentrada[59] = $_POST["nombre_nuevo_elemento"]; en uso 55 56 57 58
